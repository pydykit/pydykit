...
to visualize our package `pymetis`.
Therefore, we navigate into the package

```bash
cd python/pymetis/pymetis
```
...
```bash
pyreverse -o png -p pymetis .
```

![alt text](assets/classes_pymetis.png "Generated from pyreverse -o png -p pymetis .")
